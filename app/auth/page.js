  ...
  return (
    <div className="Authentication flex min-h-screen">
      ...
      <section className="leftContainer  flex flex-col mt-[7%] mb-[10%] items-center w-full lg:w-[40%] lg:pl-[15px]">
        ...
        <div onClick={() => setcurrentView((prev) => !prev)} className="selectorContainer w-[300px] rounded-[5px] flex justify-between bg-gray-200 p-2 relative mt-10">
          <button
          ...
          >
            {!currentView &&<p className="transition-all delay-300">Sign In</p>}
            {currentView &&<p className="transition-all delay-500">Sign Up</p>}
          </button>
          {/* Sign in Text */}
          <p className=" absolute top-[33%] left-8 font-medium text-gray-400 cursor-pointer">Sign In</p>
          {/* Sign Up Text */}
          <p className=" absolute top-[33%] font-medium right-8 text-gray-400 cursor-pointer">Sign Up</p>
        </div>
      ...
      <section></section>
      <div className="rightContainer flex-col justify-center sticky top-0 h-screen hidden lg:flex w-full">
        <div className="content  flex flex-col items-center">
          <div className="image">
            {/* <img src={HeroImage} alt="" className="w-[377px]" /> */}
            <Image src={HeroImage} className="w-[377px]" alt="heroImage" />
          </div>
          <div className="glassCard -mt-20 text-center flex items-center justify-center">
            <p className="quote">
              Budget and save smartly
              <br />
              <span className="font-[700]">To success</span>
            </p>
          </div>
        </div>
      </div>
