      ...
      <div className="grid grid-cols-2 gap-20 mt-10">
        ...
        <section>
          ...
          <div className="flex flex-col border p-4 rounded">
            ...
            {/* Button */}
            <button className="bg-yellow-500 w-[60%] p-2 mt-4 rounded text-white">Continue</button>
          ...
          <div className="loggedIn mt-10 border p-4 rounded">
            ...
            <p className="text-sm italic">Send landlord a message | Request a tour</p>
            <textarea className="w-[60%] mt-1 border rounded p-2" placeholder="send landlord a short message">
            </textarea>
            {/* Button */}
            <button className="bg-yellow-500 w-[60%] p-2 mt-4 rounded text-white">Send</button>
            </div>
